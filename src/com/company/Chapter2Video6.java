...
public class Chapter2Video6 {
    ...
    public static void main(String[] args) {
        ...
        Function<Integer, Function<Integer, Integer>> create = (x) -> (y) -> x * y;
        System.out.println(create.apply(2).apply(5));
        System.out.println(create.apply(3).apply(5));
        System.out.println(create.apply(4).apply(5));
    }
}
